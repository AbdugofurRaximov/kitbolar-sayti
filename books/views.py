...
class BooksView(View):
    def get(self, request):
        ...
        # title__icontainsdagi i harfi qidirishda katta harf bilan ham kichik harf bilan ham bir xil qidirishni taminlaydi
